...
class PingPongStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetServerResponse = channel.unary_unary(
                '/pingponggrpc.PingPong/GetServerResponse',
...
def add_PingPongServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'pingponggrpc.PingPong', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('pingponggrpc.PingPong', rpc_method_handlers)
